...
export default function ADASCalibrations() {
	return (
		<main className="font-henju">
			{/* HERO */}
			<HeroTwo
				bgImage={IMAGES.HeroADASCalibrations}
				breadcrumb={[
					{ label: "Home", href: "/" },
					{ label: "Our Services", href: "/services" },
					{ label: "ADAS Calibrations" },
				]}
			...
			<Section spacing="large">
				<SplitTextImage
					...
					title={
						<>
							<span className="text-[#024F2D]">What is ADAS?</span>
						</>
					}
					description={
						<>
			...
			<Section spacing="large" className="bg-[#F5F5F5]">
				<SplitTextImage
					...
					imageUrl={IMAGES.Why_do_we_ADAS_}
					descriptionClassName="text-lg sm:text-xl lg:text-2xl"
				/>
			</Section>
			...
			<Section spacing="large">
				<SplitTextImage
					...
					title={
						<>
							<span className="text-[#024F2D]">Why is ADAS Calibration </span>
					...
					imageUrl={IMAGES.ADAS_Calibration_Section}
					descriptionClassName="text-lg sm:text-xl lg:text-2xl"
				/>
			</Section>
			...
			<Section spacing="large">
				<SplitTextImage
					...
					imageUrl={IMAGES.Our_Commitment_Two}
					primaryCta={{
						label: "Learn More",
						variant: "primary",
					}}
